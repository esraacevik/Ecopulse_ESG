...
**Dosya:** `ecologia/backend/app/api/v1/report.py`
...
**Dosya:** `ecologia/backend/app/models/schemas.py`
...
**Dosya:** `ecologia/frontend/src/services/api.ts`
...
**Dosya:** `ecologia/frontend/src/components/ReportGenerator.tsx`
