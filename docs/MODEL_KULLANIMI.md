...
**Yol**: `modeller/outputs/models/weather_energy_model/`
...
#### B) Checkpoint (Yedek)
**Yol**: `modeller/checkpoints/weather_training/`
...
**Dosya**: `frontend/src/components/MLDashboard.tsx`
...
**Model Dosyaları**:
- Final model: `modeller/outputs/models/weather_energy_model/`
- Checkpoint: `modeller/checkpoints/weather_training/`
