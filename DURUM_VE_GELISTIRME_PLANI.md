...
**Dosyalar:**
- `ecologia/frontend/src/components/MLDashboard.tsx` (EnergyForecast component)
- `ecologia/modeller/api/ml_routes.py` (forecast endpoint - metrics ekle)
...
**Dosyalar:**
- `ecologia/frontend/src/components/MLDashboard.tsx` (AnomalyDetection, EnergyForecast)
- `ecologia/modeller/utils/data_utils.py` (validation functions)
...
**Dosyalar:**
- `ecologia/frontend/src/components/MLDashboard.tsx` (her component'e export butonu)
- `ecologia/backend/app/api/v1/export.py` (yeni endpoint)
...
**Dosyalar:**
- `ecologia/frontend/src/components/MLDashboard.tsx` (yeni TrendAnalysis component)
- `ecologia/backend/app/api/v1/ml/trends.py` (yeni endpoint)
...
**Dosyalar:**
- `ecologia/modeller/models/energy_prediction/trainer.py` (retraining logic)
- `ecologia/backend/app/api/v1/ml/retrain.py` (yeni endpoint)
- `ecologia/backend/app/services/model_monitor.py` (yeni service)
...
**Dosyalar:**
- `ecologia/backend/app/api/v1/ml/websocket.py` (yeni WebSocket endpoint)
- `ecologia/frontend/src/components/RealtimeMonitor.tsx` (yeni component)
...
**Dosyalar:**
- `ecologia/backend/app/services/notification_service.py` (yeni service)
- `ecologia/backend/app/api/v1/notifications.py` (yeni endpoint)
- `ecologia/frontend/src/components/NotificationCenter.tsx` (yeni component)
